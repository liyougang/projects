...
public class CoopSecurityUtil {
	 ...
	 * @throws SecurityException
	 */
	public static PrivateKey readPfx2Cert(String file, String passwd)
			throws SecurityException {
	...
	public static void main(String[] args) throws Exception {
		...
		PrivateKey howubyPriKey = CoopSecurityUtil.loadPrivateKey(
				"E:/temp/coop_test_key/howbuy_private.pfx", "howbuytest");
		PublicKey howbuyPubKey = CoopSecurityUtil
				.loadPublicKey("E:/temp/coop_test_key/howbuy_public.crt");

		PrivateKey merchantPriKey = CoopSecurityUtil.loadPrivateKey(
				"E:/temp/coop_test_key/merchant_private.pfx", "merchanttest");
		PublicKey merchantPubKey = CoopSecurityUtil
				.loadPublicKey("E:/temp/coop_test_key/merchant_public.crt");

		System.out.println("howubyPriKey:"
				+ Base64.encodeBase64String(howubyPriKey.getEncoded()));
		System.out.println("howbuyPubKey:"
				+ Base64.encodeBase64String(howbuyPubKey.getEncoded()));

		System.out.println("merchantPriKey:"
				+ Base64.encodeBase64String(merchantPriKey.getEncoded()));
		System.out.println("merchantPubKey:"
				+ Base64.encodeBase64String(merchantPubKey.getEncoded()));

		String data = "加密测试数据";
		System.out.println("data:" + data);

		byte[] encryptData = CoopSecurityUtil.encrypt(merchantPubKey,
				data.getBytes("UTF-8"));
		System.out.println("encryptDate:"
				+ Base64.encodeBase64String(encryptData));

		// 加签
		byte[] signature = CoopSecurityUtil.generateSignature(encryptData,
				howubyPriKey);
		System.out.println("sign:" + Base64.encodeBase64String(signature));

		// 验签
		System.out.println("vrfy sign status:"
				+ CoopSecurityUtil.verifySignature(encryptData, howbuyPubKey,
						signature));

		// 解密
		byte[] decryptData = CoopSecurityUtil.decrypt(merchantPriKey,
				encryptData);
